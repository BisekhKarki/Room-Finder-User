  ...
  return (
    <div className="px-10 py-10">
      ...
      <p className="w-2/3 mt-7 text-gray-500">
        ...
        payments, or find accommodations tailored to your interests, we have got
        you covered. Our platform is designed to connect you with the right
        options effortlessly, ensuring a seamless and personalized experience
        every step of the way. Let us help you find your ideal space today!
      </p>
