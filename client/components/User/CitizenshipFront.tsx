...
interface Props {
  setCitizenshipFront: (citizenshipFront: string) => void;
}

const CitizenshipFront = ({ setCitizenshipFront }: Props) => {
...
export default CitizenshipFront;
