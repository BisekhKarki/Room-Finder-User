...
const EditImages = ({ counter, setCounter }: Props) => {
  const [images, setImages] = useState<Array<string>>([]);

  useEffect(() => {
    const getImagesFromLocalStorage = localStorage.getItem("Edit_Post_images");
  ...
  const setRoomImages = () => {
    ...
    localStorage.setItem("Edit_Post_images", JSON.stringify(images));
